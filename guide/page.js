...
<meta property="og:site_name" content="TrendLens">
<meta property="og:title" content="Smart Money Concepts">
<meta property="og:description" content="Fifteen ICT / Smart Money Concepts terms drawn as diagrams, plus one real BTCUSD trade worked through step by step.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="Smart Money Concepts">
<meta name="twitter:description" content="Fifteen chart-reading terms, and one real trade that uses them.">
<meta name="twitter:image" content="https://trendlens.web.app/og.png">
<meta property="og:url" content="https://trendlens.web.app/guide">
<meta property="og:locale" content="en_US">
<meta property="og:image" content="https://trendlens.web.app/og.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<!-- Four hosts serve this same file; canonicalise them onto the primary. -->
<link rel="canonical" href="https://trendlens.web.app/guide">
...
<script type="application/ld+json">${JSON.stringify({
  ...
  '@type': 'TechArticle',
  // Keep this block ASCII-only: the page is written through an asciiSafe
  // pass that turns non-ASCII into HTML entities, and no JSON-LD parser
  // decodes an entity inside a <script> block.
  headline: 'Smart Money Concepts: a visual field guide',
  description:
    'Fifteen ICT / Smart Money Concepts terms drawn as diagrams, plus one real BTCUSD trade worked through step by step.',
  url: 'https://trendlens.web.app/guide',
  image: 'https://trendlens.web.app/og.png',
  inLanguage: 'en',
  isAccessibleForFree: true,
  author: { '@type': 'Person', name: 'bhurtelmahesh' },
  publisher: { '@type': 'Organization', name: 'TrendLens', url: 'https://trendlens.web.app/' },
  isPartOf: { '@type': 'WebSite', name: 'TrendLens', url: 'https://trendlens.web.app/' },
  articleSection: ['Market structure', 'Liquidity', 'Order blocks', 'Worked example'],
